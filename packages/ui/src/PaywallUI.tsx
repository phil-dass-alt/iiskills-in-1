...
export interface PaywallUIProps {
  courseId: string;
}
 ...
 *
 * The ONLY place in the codebase where purchase/upgrade prompts live.
 * AccessGuard decides whether to render this or the real lesson content.
 */
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center">
      <div className="max-w-md space-y-6">
        ...
        <a
          href={`https://iiskills.in/enroll?course=${encodeURIComponent(courseId)}`}
        ...
        <p className="text-sm text-charcoal/50">
          Already enrolled?{' '}
          <a href="https://iiskills.in/login" className="text-accent hover:underline">
            Sign in
          </a>
        </p>
      </div>
