...
const COURSE_ID = 'learn-management';
...
/**
 * Individual lesson page for Business Management.
 *
...
export default async function LessonPage({ params }: LessonPageProps) {
  ...
  if (!lesson) {
    return (
      <main className="p-8">
        <Link href="/" className="text-primary hover:underline text-sm">← Back to Business Management</Link>
