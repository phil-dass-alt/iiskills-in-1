...
const COURSE_ID = 'learn-developer';
...
/**
 * Individual lesson page for Web Development.
 *
...
export default async function LessonPage({ params }: LessonPageProps) {
  ...
  if (!lesson) {
    return (
      <main className="p-8">
        <Link href="/" className="text-primary hover:underline text-sm">← Back to Web Development</Link>
