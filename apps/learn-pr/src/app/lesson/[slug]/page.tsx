...
/**
 * Individual lesson page for Public Relations.
 *
...
export default async function LessonPage({ params }: LessonPageProps) {
  ...
  if (!lesson) {
    return (
      <main className="p-8">
        <Link href="/" className="text-primary hover:underline text-sm">← Back to Public Relations</Link>
